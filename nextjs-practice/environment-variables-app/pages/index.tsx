...
export async function getStaticProps() {
  ...
  console.debug('.env: process.env.ENV_VARIABLE:', process.env.ENV_VARIABLE);
  console.debug('.env: process.env.NEXT_PUBLIC_ENV_VARIABLE:', process.env.NEXT_PUBLIC_ENV_VARIABLE);
  console.debug('.env.development: process.env.DEVELOPMENT_ENV_VARIABLE:', process.env.DEVELOPMENT_ENV_VARIABLE);
  console.debug('.env.development: process.env.NEXT_PUBLIC_DEVELOPMENT_ENV_VARIABLE:', process.env.NEXT_PUBLIC_DEVELOPMENT_ENV_VARIABLE);
  console.debug('.env.local.example: process.env.ENV_LOCAL_VARIABLE:', process.env.ENV_LOCAL_VARIABLE);
  console.debug('.env.local.example: process.env.NEXT_PUBLIC_ENV_LOCAL_VARIABLE:', process.env.NEXT_PUBLIC_ENV_LOCAL_VARIABLE);
  console.debug('.env.production: process.env.PRODUCTION_ENV_VARIABLE:', process.env.PRODUCTION_ENV_VARIABLE);
  console.debug('.env.production: process.env.NEXT_PUBLIC_PRODUCTION_ENV_VARIABLE:', process.env.NEXT_PUBLIC_PRODUCTION_ENV_VARIABLE);
